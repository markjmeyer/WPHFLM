function res = wphflm_fit(Y,model,wpspecs,MCMCspecs) 
%wphflm_fit Fits the Wavelet-Packet Historical Functional Linear Model and returns
...
%
%   RES = wphflm_fit(Y, model, wpwspecs, MCMCspecs) returns posterior
