function regstr = registerfd(y0fd, yfd, Wfd0, Lfdobj, lambda, periodic, ...
...
if nargin <  9, conv    = 1e-2;       end
if nargin <  8, dbglev  = 1;          end
if nargin <  7, iterlim = 5;          end
if nargin <  6, periodic= 0;          end
...
for icurve = 1:ncurve
  ...
  yregfdi = regyfn(xfine, yfine, hfine, yfdi, Wfdi, penmat, periodic);
...
function Fstr = regfngrad(xfine, y0fine, Dhfine, yregfd, Wfd, Kmat, periodic, crit)
...
function hessmat = reghess(xfine, y0fine, Dhfine, D2hwrtc, yregfd, Kmat, ...
                           nbasis, norder, periodic, crit)
...
function yregfd = regyfn(xfine, yfine, hfine, yfd, Wfd, penmat, periodic)
