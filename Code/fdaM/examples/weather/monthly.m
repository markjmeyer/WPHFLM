...
%  define global variables needed in functions called by monthlymenu
...
tempfine = eval_fd(tempfd(stnindex), xfine);
...
xfine = linspace(0,12,101)';
tempLfine = eval_fd(tempfd(stnindex), xfine, harmaccelLfd);
...
print -dpsc2 'c:/Myfiles/talks/fdacourse/figs/temppca3.ps'
